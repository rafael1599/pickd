      ...
      {!isBoardOpen && (
        ...
        >
          <div
            ...
            transition-all duration-300 ease-in-out md:border md:border-subtle/50 md:bg-card/90 md:backdrop-blur-xl md:shadow-xl translate-y-0 opacity-100 pointer-events-auto
