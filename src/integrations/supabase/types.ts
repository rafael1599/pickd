  ...
  public: {
    ...
    Functions: {
      ...
      cancel_combined_order: {
        Args: { p_group_id: string; p_unship?: boolean; p_user_id: string };
        Returns: Json;
      };
      cancel_completed_order: {
        Args: { p_list_id: string; p_unship?: boolean; p_user_id: string };
        Returns: Json;
      };
      cancel_reopen: {
      ...
      resolve_sku_chain: { Args: { p_sku: string }; Returns: string[] };
      ...
      update_inventory_log_note: {
        Args: { p_log_id: string; p_note: string; p_user_id: string };
        Returns: Json;
      };
