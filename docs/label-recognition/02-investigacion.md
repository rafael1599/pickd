...
| -------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| **F0 · Banco**                         | Re-verificar la verdad de terreno a mano; arnés que pase barras + OCR + Gemini + Sonnet (y Gemma 4 si hay teléfono) por las 15 fotos; métricas por campo y error silencioso; test de dígitos tapados. < $2 en APIs. | Sin esto, cada decisión posterior es opinión.                           |
| **F1 · Barras bien hechas**            | `useBarcodeScanner`/`useQRScanner` a resolución completa, varias barras por foto, QR de las A, Code 39 con confirmación.                                                                                            | Útil hoy en todo PickD, y es la fuente que no inventa.                  |
