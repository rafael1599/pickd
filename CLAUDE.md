...
banda de último recurso (9999, y `pick_priority = 'last'` desde el 18 sep 2026) y
`counts_as_storage = false`. **Al 18 sep tiene 18.775 unidades en 149 SKUs**, todas partes —cámaras,
tapones de válvula, portabidones, manillares— escritas por el reconcile del AS400 sobre los
placeholders del catálogo. Filtrar por ella **es** la lista de
